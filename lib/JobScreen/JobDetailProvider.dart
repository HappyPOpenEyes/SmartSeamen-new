    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (int i = 0; i < jobDetailResponse.data.length; i++) {
          ...
          tentaiveJoiningDate
              .add(jobDetailResponse.data[i].tentativeJoiningDate);
          print(jobDetailResponse.data[i].description);
          // final document = parse(
          //     jobDetailResponse.data[i].description ?? "This is description");
          ...
          for (int j = 0;
            ...
            print('Inside');
            print(jobDetailResponse.data[i].getrankdetail.length);
            deckexperiences.add(jobDetailResponse
                .data[i].getrankdetail[j].experience
                .toString());
          ...
          for (int j = 0;
            ...
            navexperiences.add(jobDetailResponse
                ...
                .toString());
            navigationRanks
                .add(jobDetailResponse.data[i].getrankdetail1[j].rank);
          }
          ...
          for (int j = 0;
            ...
            for (int k = 0;
                k <
                    jobDetailResponse
                        .data[i].getrankdetail1[j].cocIssuing.length;
                k++) {
          ...
          for (int j = 0;
            ...
            for (int k = 0;
                k <
                    jobDetailResponse
                        .data[i].getrankdetail[j].cocIssuing.length;
                k++) {
