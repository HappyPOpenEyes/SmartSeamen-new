...
class SocialMediaDisconnectProvider extends ChangeNotifier {
  Future<String> callSocialMediaDisconnectProviderapi(
      providername, header) async {
    var body = {"provider_name": providername};
    try {
      var response = await http.post(Uri.parse(apiurl + '/disconnect'),
