...
class EmailOTPSendProvider extends ChangeNotifier {
  bool success = false;
  Future<bool> callEmailOtpSendapi(email, userid, header) async {
    var body = {"email_id": email, "id": userid};
    print(body);
    try {
      var response = await http.post(Uri.parse(apiurl + '/emailotpsend'),
